                    ...
                    <div className="fixed inset-0 flex items-center justify-center z-50">
                        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 max-w-md w-full relative">
                            ...
                            <header className="text-center mb-6">
                                <h2 className="text-xl font-bold dark:text-white">Pin Verification</h2>
                            ...
                            <form onSubmit={handleSubmit}>
                                ...
                                <button
                                    type="submit"
                                    className="w-full py-2 bg-indigo-500 text-white rounded-lg shadow-md hover:bg-indigo-600 transition-colors"
                                >
                                    Verify
                                </button>
                            </form>
